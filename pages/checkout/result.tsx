...
export default function CheckoutResult({
  ...
  }, [cartItems, status, cart, customer?.email, customer?.firstname, customer?.lastname, recordAnalytic, router.query.incrementOrderID, searchCookie]);
        ...
        <Container style={{ backgroundColor: "#FAFAFA" }}>
          <div className="flex flex-col justify-center items-center p-10 gap-10">
            <div className="h-28 w-48 relative">
              <Image src="/images/payment-success.png" alt=""/>
            </div>
